    ...
    buttons = [
        [
            InlineKeyboardButton(
                        "💥 𝐉𝐨𝐢𝐧 𝐎𝐮𝐫 𝐂𝐡𝐚𝐭 𝐆𝐫𝐨𝐮𝐩 💞", url=f"https://t.me/+BGIiDOFoWIplYTY1"
            )
        ],
        [           
            InlineKeyboardButton(
                text="💥 𝐉𝐨𝐢𝐧 𝐎𝐮𝐫 𝐂𝐡𝐚𝐧𝐧𝐞𝐥 💞", url=f"https://t.me/darkdevil9793"
            )
        ],
        [           
            InlineKeyboardButton(
                text="📱 𝐘𝐨𝐮𝐭𝐮𝐛𝐞 📱", url=f"https://youtube.com/@ALEXHUNTERSYT"
            )
        ],
    ]
    return buttons
