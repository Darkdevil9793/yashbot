...
async def repo(client: Client, message: Message):
    await message.reply_photo(
        photo=f"https://telegra.ph/file/12cee88bb45a081d6d784.jpg",
  ...
  [𝐘𝐨𝐮𝐭𝐮𝐛𝐞](https://youtube.com/@bika)""",
        reply_markup=InlineKeyboardMarkup(
            ...
            [
                ...
                [
                    InlineKeyboardButton(
                        "🥀 𝐒𝐮𝐩𝐩𝐨𝐫𝐭 🥀", url=f"https://t.me/+BGIiDOFoWIplYTY1"
                    ),
                    InlineKeyboardButton(
                        "🥀 𝐔𝐩𝐝𝐚𝐭𝐞𝐬 🥀", url=f"https://t.me/+BGIiDOFoWIplYTY1")
                ]
            ]
        ),
    ) 
...
# Join @BikashGadgetsTech For More Update
# Join @AdityaCheats For Hack
# Join Our Chats @Bgt_Chat & @Adityadiscus Adityadiscus 